...
//  Lecture9
//
//  Created by Michelle on 7/20/16.
...
class ViewController: UITableViewController {
    ...
    //in final project, parsed json file that is loaded into the table view
    ...
    // slash slash mark semicolon makes it bold and helps you navigate
    ...
    {
        let editingRow = (sender as! UITableViewCell).tag //row in array that i tapped on
